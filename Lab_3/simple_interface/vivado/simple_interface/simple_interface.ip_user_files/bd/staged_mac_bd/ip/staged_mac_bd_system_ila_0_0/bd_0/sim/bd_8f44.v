...
(* CORE_GENERATION_INFO = "bd_8f44,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_8f44,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "staged_mac_bd_system_ila_0_0.hwdef" *) 
module bd_8f44
   (SLOT_0_AXIS_tdata,
    SLOT_0_AXIS_tid,
    SLOT_0_AXIS_tlast,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_2_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_2_AXIS, CLK_DOMAIN staged_mac_bd_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 8, TUSER_WIDTH 0" *) input [15:0]SLOT_2_AXIS_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_2_AXIS TID" *) input [7:0]SLOT_2_AXIS_tid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_3_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_3_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN staged_mac_bd_processing_system7_0_0_FCLK_CLK0, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 8, NUM_READ_THREADS 4, NUM_WRITE_OUTSTANDING 8, NUM_WRITE_THREADS 4, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]SLOT_3_AXI_araddr;
  ...
  assign Conn2_TID = SLOT_2_AXIS_tid[7:0];
  ...
  bd_8f44_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe11(net_slot_2_axis_tid),
        .probe12(net_slot_2_axis_tvalid),
        .probe13(net_slot_2_axis_tready),
        .probe14(net_slot_2_axis_tlast),
        .probe15(net_slot_3_axi_ar_cnt),
        .probe16(net_slot_3_axi_araddr),
        .probe17(net_slot_3_axi_aw_cnt),
        .probe18(net_slot_3_axi_awaddr),
        .probe19(net_slot_3_axi_b_cnt),
        .probe2(net_slot_0_axis_tvalid),
        .probe20(net_slot_3_axi_bresp),
        .probe21(net_slot_3_axi_r_cnt),
        .probe22(net_slot_3_axi_rdata),
        .probe23(net_slot_3_axi_rresp),
        .probe24(net_slot_3_axi_wdata),
        .probe25(net_slot_3_axi_wstrb),
        .probe26(net_slot_3_axi_aw_ctrl),
        .probe27(net_slot_3_axi_w_ctrl),
        .probe28(net_slot_3_axi_b_ctrl),
        .probe29(net_slot_3_axi_ar_ctrl),
        .probe3(net_slot_0_axis_tready),
        .probe30(net_slot_3_axi_r_ctrl),
