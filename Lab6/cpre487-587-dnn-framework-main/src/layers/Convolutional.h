...
class ConvolutionalLayer : public Layer {
   public:
    ConvolutionalLayer(const LayerParams inParams, const LayerParams outParams, const LayerParams weightParams, const LayerParams biasParams, const int layerNum, const bool doMaxPool)
    ...
    const bool getDoMaxPool() const {return doMaxPool;}
