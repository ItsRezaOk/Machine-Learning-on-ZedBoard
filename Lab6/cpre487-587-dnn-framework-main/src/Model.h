...
class Model {
   public:
    ...
    // Functions
    const LayerData& inference(const LayerData& inData, const Layer::InfType infType = Layer::InfType::COMPUTEACCELERATED) const;
    const LayerData& inferenceLayer(const LayerData& inData, const int layerNum, const Layer::InfType infType = Layer::InfType::COMPUTEACCELERATED) const;
    ...
    inline const LayerData& operator()(const LayerData& inData, const Layer::InfType infType = Layer::InfType::COMPUTEACCELERATED) const {
        return inference(inData, infType);
    }
    inline const LayerData& operator()(const LayerData& inData, const int layerNum, const Layer::InfType infType = Layer::InfType::COMPUTEACCELERATED) const {
