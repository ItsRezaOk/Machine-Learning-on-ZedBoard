...
connect_debug_port u_ila_0/probe0 [get_nets [list {conv_accelerator_bd_i/axi_crossbar_1_M01_AXI_ARBURST[2]} {conv_accelerator_bd_i/axi_crossbar_1_M01_AXI_ARBURST[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 2 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {conv_accelerator_bd_i/axi_crossbar_1_M01_AXI_AWBURST[2]} {conv_accelerator_bd_i/axi_crossbar_1_M01_AXI_AWBURST[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list conv_accelerator_bd_i/axi_crossbar_1_M01_AXI_ARLOCK]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list conv_accelerator_bd_i/axi_crossbar_1_M01_AXI_AWLOCK]]
