...
entity dequantization is
    generic(
        ...
        SCALE_FRACTIONAL_BITS : integer := 16-- q_scale is interpreted as Q(32-SCALE_FRACTIONAL_BITS).SCALE_FRACTIONAL_BITS
    );
    port(
...
architecture Behavioral of dequantization is
    ...
    signal scaled_val : signed(C_DATA_WIDTH-1 downto 0);
    signal input_val  : signed(C_DATA_WIDTH-1 downto 0);
    signal scale_val  : signed(C_DATA_WIDTH-1 downto 0);
    signal zero_val   : signed(C_OUT_WIDTH-1 downto 0);
    signal relu_val   : signed(C_DATA_WIDTH-1 downto 0);
    signal biased_val : signed(C_DATA_WIDTH-1 downto 0);
    signal quant_val  : signed(C_OUT_WIDTH-1 downto 0);
...
begin
    ...
    relu_val <= (others => '0') WHEN (relu = '1' and scaled_val(scaled_val'high) = '1') ELSE
                scaled_val;
