...
//               /home/cam2022/CPRE-487_git/CPRE-4870/Lab4/hw/variable_mac_implementation/vivado/simple_interface/simple_interface.srcs/sources_1/bd/staged_mac_bd/ip/staged_mac_bd_staged_mac_0_0/staged_mac_bd_staged_mac_0_0_stub.v
...
/* synthesis syn_black_box black_box_pad_pin="ACLK,ARESETN,SD_AXIS_TREADY,SD_AXIS_TDATA[23:0],SD_AXIS_TLAST,SD_AXIS_TUSER,SD_AXIS_TVALID,SD_AXIS_TID[7:0],MO_AXIS_TVALID,MO_AXIS_TDATA[31:0],MO_AXIS_TLAST,MO_AXIS_TREADY,MO_AXIS_TID[7:0]" */;
  input ACLK;
  input ARESETN;
  output SD_AXIS_TREADY;
  input [23:0]SD_AXIS_TDATA;
  input SD_AXIS_TLAST;
  input SD_AXIS_TUSER;
