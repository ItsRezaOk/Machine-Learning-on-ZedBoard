...
--               /home/cam2022/CPRE-487_git/CPRE-4870/Lab4/hw/staged_mac_4bit_implementation/vivado/simple_interface/simple_interface.srcs/sources_1/bd/staged_mac_bd/ip/staged_mac_bd_staged_mac_0_0/staged_mac_bd_staged_mac_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of staged_mac_bd_staged_mac_0_0_staged_mac is
  ...
  signal \NLW_ARG__0_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_ARG__0_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
...
\ARG__0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \ARG__0_carry_n_0\,
      CO(3 downto 2) => \NLW_ARG__0_carry__0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \ARG__0_carry__0_n_2\,
      CO(0) => \NLW_ARG__0_carry__0_CO_UNCONNECTED\(0),
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \ARG__0_carry__0_i_1_n_0\,
      O(3 downto 1) => \NLW_ARG__0_carry__0_O_UNCONNECTED\(3 downto 1),
      O(0) => RESIZE(6),
      S(3 downto 1) => B"001",
      S(0) => \ARG__0_carry__0_i_2_n_0\
    );
...
\ARG__0_carry__0_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"569A"
    )
        port map (
...
\ARG__0_carry_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1DE2"
    )
        port map (
...
\ARG__0_carry_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\ARG__0_carry_i_12\: unisim.vcomponents.LUT6
    generic map(
...
\ARG__0_carry_i_13\: unisim.vcomponents.LUT6
    generic map(
...
\ARG__0_carry_i_14\: unisim.vcomponents.LUT6
    generic map(
...
\ARG__0_carry_i_15\: unisim.vcomponents.LUT6
    generic map(
...
\ARG__0_carry_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ARG__0_carry_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
\ARG__0_carry_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88877787"
    )
        port map (
...
\ARG__0_carry_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\ARG_inferred__0/i__carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => accumulated_value(10 downto 8),
      DI(0) => \ARG__0_carry__0_n_2\,
