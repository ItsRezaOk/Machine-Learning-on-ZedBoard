...
-- Date        : Mon Oct 27 18:05:59 2025
-- Host        : co2050-04.ece.iastate.edu running 64-bit unknown
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               /home/cam2022/CPRE-487_git/CPRE-4870/Lab4/hw/piped_mac_2bit/vivado/tc_piped_mac/tc_piped_mac.sim/sim_1/impl/func/xsim/piped_mac_func_impl.vhd
-- Design      : piped_mac
...
entity piped_mac is
  ...
  attribute C_DATA_WIDTH of piped_mac : entity is 2;
  attribute ECO_CHECKSUM : string;
  attribute ECO_CHECKSUM of piped_mac : entity is "5ad5b969";
end piped_mac;
...
architecture STRUCTURE of piped_mac is
  ...
  signal SD_AXIS_TDATA_IBUF : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal \mo_tdata_reg[7]_i_6_n_0\ : STD_LOGIC;
  signal \mo_tdata_reg[7]_i_7_n_0\ : STD_LOGIC;
  signal \mo_tdata_reg[7]_i_8_n_0\ : STD_LOGIC;
  signal \mo_tdata_reg[7]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \s1_product_reg[3]_i_1\ : label is "soft_lutpair0";
...
\mo_tdata_reg[11]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\mo_tdata_reg[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\mo_tdata_reg[7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\mo_tdata_reg[7]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\mo_tdata_reg[7]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\mo_tdata_reg[7]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B7"
    )
        port map (
      ...
      O => \mo_tdata_reg[7]_i_6_n_0\
    );
\mo_tdata_reg[7]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B7"
    )
        port map (
      ...
      O => \mo_tdata_reg[7]_i_7_n_0\
    );
\mo_tdata_reg[7]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B7"
    )
        port map (
      ...
      O => \mo_tdata_reg[7]_i_8_n_0\
    );
\mo_tdata_reg[7]_i_9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
\mo_tdata_reg_reg[7]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \mo_tdata_reg[7]_i_2_n_0\,
      DI(2) => \mo_tdata_reg[7]_i_3_n_0\,
      DI(1) => \mo_tdata_reg[7]_i_4_n_0\,
      DI(0) => \mo_tdata_reg[7]_i_5_n_0\,
      O(3 downto 0) => p_0_in(7 downto 4),
      S(3) => \mo_tdata_reg[7]_i_6_n_0\,
      S(2) => \mo_tdata_reg[7]_i_7_n_0\,
      S(1) => \mo_tdata_reg[7]_i_8_n_0\,
      S(0) => \mo_tdata_reg[7]_i_9_n_0\
    );
...
\s1_product_reg[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F0F00AC0"
    )
        port map (
...
\s2_accumulated_value_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \s1_product_reg_reg_n_0_[3]\,
      DI(2) => \s1_product_reg_reg_n_0_[3]\,
      DI(1) => \s1_product_reg_reg_n_0_[3]\,
      DI(0) => \s1_product_reg_reg_n_0_[3]\,
