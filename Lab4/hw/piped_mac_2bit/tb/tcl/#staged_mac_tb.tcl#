...
add_force {/staged_mac/SD_AXIS_TDATA} -radix hex {5 0ns}
...
add_force {/staged_mac/SD_AXIS_TDATA} -radix hex {A 0ns}
add_force {/staged_mac/SD_AXIS_TUSER} -radix hex {0 0ns}
run 10ns
add_force {/staged_mac/SD_AXIS_TVALID} -radix hex {1 0ns}
add_force {/staged_mac/SD_AXIS_TLAST} -radix hex {1 0ns}
add_force {/staged_mac/SD_AXIS_TID} -radix hex {4 0ns}
add_force {/staged_mac/SD_AXIS_TDATA} -radix hex {B 0ns}
add_force {/staged_mac/SD_AXIS_TUSER} -radix hex {0 0ns}
run 10ns
add_force {/staged_mac/SD_AXIS_TVALID} -radix hex {0 0ns}
run 50ns
...
add_force {/staged_mac/SD_AXIS_TDATA} -radix hex {0006 0ns}
...
add_force {/staged_mac/SD_AXIS_TDATA} -radix hex {9 0ns}
run 10ns
add_force {/staged_mac/SD_AXIS_TVALID} -radix hex {0 0ns}
run 50 ns
# Expected:
...
add_force {/staged_mac/SD_AXIS_TDATA} -radix hex {7 0ns}
add_force {/staged_mac/SD_AXIS_TUSER} -radix hex {0 0ns}
run 10ns
add_force {/staged_mac/SD_AXIS_TVALID} -radix hex {0 0ns}
run 30ns
